...
<main>
    <body>
        ...
        <input type="text" name="nome" id="nome" placeholder="{nomePlaceholder}">
        <br>
        <input type="text" name="cognome" id="cognome" placeholder="{cognomePlaceholder}">
        <br>
        <input type="text" name="altezza" id="altezza" placeholder="{altezzaPlaceholder}">
        <br>
        <input type="text" name="peso" id="peso" placeholder="{pesoPlaceholder}">
        <br>
        <input type="text" name="colore_capelli" id="colore_capelli" placeholder="{colore_capelliPlaceholder}">
        <br>
        <input type="text" name="colore_occhi" id="colore_occhi" placeholder="{colore_occhiPlaceholder}">
        <br>
        <input type="text" name="eta" id="eta" placeholder="{etaPlaceholder}">
        <br>
        <input type="text" name="citta" id="citta" placeholder="{cittaPlaceholder}">
        <br>
        <input type="text" name="sesso" id="sesso" placeholder="{sessoPlaceholder}">
        <br>
